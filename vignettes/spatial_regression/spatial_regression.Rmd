---
title: "Spatial regression vignette"
...
We will start by running the wingen functions to create a genetic diversity raster. Our predictor layer (`lotr_lyr`) is the layer that controlled carrying capacity and connectivity in the simulation. In this case, we know that this layer is the primary driver of genetic diversity. 
